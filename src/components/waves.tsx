...
export function Waves() {
  return (
    <div className='pointer-events-none absolute inset-0 flex h-full w-full items-center justify-center overflow-hidden rounded-lg'>
      <WaterRippleEffect
        waveSpeedX={0.02}
        waveSpeedY={0.01}
        waveAmpX={50}
      ...
      />
      <div className='relative z-10 mx-auto px-4 text-center text-white md:px-6'>
        <h2
          className='mb-4 text-4xl font-bold tracking-wider sm:text-5xl lg:text-6xl'
